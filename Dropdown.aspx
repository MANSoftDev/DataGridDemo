<%@ Page language="c#" Codebehind="Dropdown.aspx.cs" AutoEventWireup="false" Inherits="DataGridDemo.Dropdown" %>
			...
			<asp:datagrid id="DataGrid1" style="Z-INDEX: 101; LEFT: 11px; POSITION: absolute; TOP: 45px" runat="server" AutoGenerateColumns="False">
				<Columns>
					...
					<asp:TemplateColumn HeaderText="First Name">
						...
						<EditItemTemplate>
							<asp:dropdownlist ID="dlNames" DataSource='<%# LoadNames() %>' DataTextField="au_fname" runat="server">
							</asp:dropdownlist>
						</EditItemTemplate>
					</asp:TemplateColumn>
